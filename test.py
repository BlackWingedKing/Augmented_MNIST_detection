...
if __name__ == '__main__':
    ...
    try:
        ...
        ssd = keras.models.load_model("./models/ssd1.h5")
    ...
    for i, (filename, imgs, gt_confs, gt_locs) in enumerate(
        ...
        original_image = Image.open(
            os.path.join(info['image_dir'], filename))
        boxes *= original_image.size * 2
        visualizer.save_image(original_image, boxes, classes, filename)
